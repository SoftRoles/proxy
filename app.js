...
app.use('/filesystem', proxy({ target: 'http://127.0.0.1:3000/authorize', changeOrigin: true }));
// app.use('/webscrap', proxy({ target: 'http://127.0.0.1:3003', changeOrigin: true }));
app.use('/database', proxy({ target: 'http://127.0.0.1:3007/authorize/service', changeOrigin: true }));
app.use('/authorize', proxy({ target: 'http://127.0.0.1:3007', changeOrigin: true }));
